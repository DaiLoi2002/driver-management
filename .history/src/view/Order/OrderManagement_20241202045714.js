      ...
      {isModalOpen && selectedOrder && (
        ...
        >
          ...
          >
            ...
            <p>
              <strong>Số KM:</strong> {selectedOrder.distance}
            </p>
            <p>
              <strong>Giá:</strong> {selectedOrder.totalAmount}
            </p>
            <p>
              <strong>Số điểm dừng:</strong> {selectedOrder.deliveryInfo.length}
            </p>
            <p>
              <strong>Trạng thái:</strong> {selectedOrder.statusOrder}
            </p>
            <button
              onClick={closeModal}
              style={{
