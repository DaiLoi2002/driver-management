...
const VoucherManagement = () => {
  ...
  useEffect(() => {
    const fetchedVouchers = voucherViewModel.getVoucher(userGroup, isActive); // Gọi hàm lấy voucher từ ViewModel
    // Lưu trữ dữ liệu vào biến const
    // voucherViewModel.vouchers;
    console.log("fetchedVouchers", fetchedVouchers);
