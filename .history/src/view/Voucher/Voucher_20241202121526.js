...
const VoucherManagement = () => {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <select
          value={isActive ? "true" : "false"} // Đồng bộ hóa với state isActive, sử dụng chuỗi "true" hoặc "false"
          onChange={(e) => setIsActive(e.target.value === "true")} // Chuyển đổi chuỗi "true"/"false" thành boolean
          style={{
            padding: "10px",
            width: "100%",
            maxWidth: "200px",
